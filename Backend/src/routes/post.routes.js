...
/**
* @route GET /api/post/feed [protected]
* @description get all the post with there user details
*/
postRouter.get('/feed', identifyUser, postController.getPostFeedController)
